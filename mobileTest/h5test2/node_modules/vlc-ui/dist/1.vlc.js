...
var _chinaAreaData = __webpack_require__(247);
...
exports.default = {
    ...
    methods: {
        ...
        _filter: function _filter(id, target) {

            var result = [];

            var items = _chinaAreaData2.default[id];
...
module.exports = { render: function render() {
    ...
    return _c('div', {
      ...
      attrs: {
        "list": _vm.provinces,
        "init-item": _vm.province,
        "target": 'province'
      },
      on: {
        "change": _vm.change
      }
    }), _vm._v(" "), _c('picker-slot', {
      attrs: {
        "list": _vm.citys,
        "init-item": _vm.city,
        "target": 'city'
